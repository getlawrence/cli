...
func (d *CodeGenDetector) Category() types.Category {
...
func (d *CodeGenDetector) Detect(ctx context.Context, analysis *Analysis) ([]types.Issue, error) {
...
func (d *CodeGenDetector) isAlreadyInstrumented(analysis *Analysis, instr types.InstrumentationInfo) bool {
...
func (d *CodeGenDetector) detectCommonPatterns(analysis *Analysis) []types.Issue {
	var issues []types.Issue
...
func (d *CodeGenDetector) detectGoPatterns(files []string, analysis *Analysis) []types.Issue {
	var issues []types.Issue
...
func (d *CodeGenDetector) detectPythonPatterns(files []string, analysis *Analysis) []types.Issue {
	var issues []types.Issue
...
func (d *CodeGenDetector) detectJSPatterns(files []string, analysis *Analysis) []types.Issue {
	var issues []types.Issue
